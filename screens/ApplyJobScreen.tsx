...
const styles = StyleSheet.create({
  ...
  label: { fontSize: theme.type.body, fontWeight: '600', color: theme.colors.text, marginTop: 12, marginBottom: 6 },
  hint: { fontSize: theme.type.small, color: theme.colors.muted, marginBottom: 6 },
  input: {
    ...theme.inputStyle,
  ...
  attachBtnText: { color: theme.colors.primary, fontSize: theme.type.body, flex: 1 },
  removeBtn: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 8 },
  removeBtnText: { color: theme.colors.danger, fontSize: theme.type.caption },
  primary: {
  ...
  muted: { color: theme.colors.muted, padding: theme.spacing.md, fontSize: theme.type.body },
});
