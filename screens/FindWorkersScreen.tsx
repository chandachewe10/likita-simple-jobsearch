...
const styles = StyleSheet.create({
  ...
  locationNoticeText: { flex: 1, fontSize: 13, color: theme.colors.text, lineHeight: 18 },
  filterBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
  ...
  filterBtnText: { flex: 1, fontSize: 14, color: theme.colors.text, fontWeight: '600' },
  selectedSkills: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: 6,
  ...
  selectedPillText: { color: theme.colors.onPrimary, fontSize: 12, fontWeight: '600' },
  clearText: { color: theme.colors.primary, fontSize: 13, fontWeight: '600', marginLeft: 4 },
  resultCount: { fontSize: 13, color: theme.colors.muted, marginBottom: 8 },
  ...
  modalItemTextSelected: { fontWeight: '700', color: theme.colors.primary },
  doneBtn: {
    backgroundColor: theme.colors.primary,
    padding: 14,
  ...
  doneBtnText: { color: theme.colors.onPrimary, fontWeight: '700' },
});
