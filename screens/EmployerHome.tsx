...
const styles = StyleSheet.create({
  ...
  findTitle: { fontSize: 16, fontWeight: '700', color: theme.colors.text },
  findSubtitle: { fontSize: 12, color: theme.colors.muted, marginTop: 4, lineHeight: 17 },
  findMeta: { fontSize: 12, color: theme.colors.primary, marginTop: 6, fontWeight: '600' },
  sectionTitle: {
    fontSize: 15,
    fontWeight: '700',
