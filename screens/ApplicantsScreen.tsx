...
const styles = StyleSheet.create({
  ...
  name: { fontWeight: '700', fontSize: theme.type.headline, color: theme.colors.text },
  statusBadge: { fontSize: theme.type.small, fontWeight: '700', textTransform: 'capitalize' },
  appliedDate: { color: theme.colors.muted, fontSize: theme.type.small, marginTop: 4 },
  section: { marginTop: 14 },
  sectionTitle: { fontSize: theme.type.caption, fontWeight: '700', color: theme.colors.text, marginBottom: 6 },
  detailRow: { marginBottom: 4 },
  detailLabel: { fontSize: theme.type.small, color: theme.colors.muted },
  detailValue: { fontSize: theme.type.body, color: theme.colors.text },
  ratingRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  ratingText: { fontSize: theme.type.caption, color: theme.colors.text },
  coverLetter: { fontSize: theme.type.body, color: theme.colors.text, lineHeight: theme.lineHeight.body },
  resumeBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
  ...
  resumeBtnText: { color: theme.colors.primary, fontSize: theme.type.body, fontWeight: '600' },
  ...
  acceptBtnText: { color: theme.colors.onPrimary, fontWeight: '700', fontSize: theme.type.body },
  rejectBtn: {
    flex: 1,
  ...
  rejectBtnText: { color: theme.colors.onPrimary, fontWeight: '700', fontSize: theme.type.body },
  completeBtn: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  completeBtnText: { color: theme.colors.onPrimary, fontWeight: '700', fontSize: theme.type.body },
  ...
  paidText: { color: theme.colors.success, fontSize: theme.type.caption, fontWeight: '600', flex: 1 },
});
