...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: theme.type.caption, fontWeight: '700', color: theme.colors.text, marginBottom: 8 },
  notice: {
  ...
  errorText: { flex: 1, color: theme.colors.danger, fontSize: theme.type.caption, lineHeight: theme.lineHeight.small },
  generateBtn: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  generateText: { color: theme.colors.onPrimary, fontWeight: '700', fontSize: theme.type.body },
  reviewBox: {
  ...
  badgeText: { color: '#fff', fontWeight: '700', fontSize: theme.type.small },
  summary: { fontSize: theme.type.body, color: theme.colors.text, lineHeight: theme.lineHeight.body },
  refreshBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 6,
  ...
  refreshText: { color: theme.colors.primary, fontWeight: '600', fontSize: theme.type.caption },
});
