...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 13, color: theme.colors.muted, marginTop: 4, marginBottom: 16, lineHeight: 19 },
  ...
  operatorText: { fontWeight: '600', color: theme.colors.text },
  operatorTextActive: { color: theme.colors.onPrimary },
  ...
  payBtnText: { color: theme.colors.onPrimary, fontWeight: '700' },
