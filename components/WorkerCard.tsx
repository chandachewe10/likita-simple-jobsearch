...
const styles = StyleSheet.create({
  ...
  titleBlock: { flex: 1 },
  name: { fontSize: theme.type.headline, fontWeight: '700', color: theme.colors.text },
  certified: { fontSize: theme.type.small, color: theme.colors.success, marginTop: 2, fontWeight: '600' },
  distancePill: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 4,
  ...
  distanceText: { fontSize: theme.type.small, color: theme.colors.primary, fontWeight: '600' },
  ratingRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 10 },
  ratingText: { fontSize: theme.type.caption, color: theme.colors.text, fontWeight: '600' },
  muted: { fontSize: theme.type.caption, color: theme.colors.muted },
  ...
  moreSkills: { fontSize: theme.type.small, color: theme.colors.muted },
  address: { fontSize: theme.type.small, color: theme.colors.muted, marginTop: 8 },
  callBtn: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  callBtnText: { color: theme.colors.onPrimary, fontWeight: '700', fontSize: theme.type.body },
});
