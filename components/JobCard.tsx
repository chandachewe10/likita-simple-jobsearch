...
const styles = StyleSheet.create({
  ...
  desc: { marginTop: 8, color: theme.colors.muted, fontSize: theme.type.body, lineHeight: theme.lineHeight.body },
  footer: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 12 },
  skillsRow: { flexDirection: 'row' },
  skillPill: { backgroundColor: theme.colors.surfaceVariant, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 12, marginRight: 8 },
  skillText: { fontSize: theme.type.small, color: theme.colors.text },
  button: { backgroundColor: theme.colors.primary, paddingHorizontal: 14, paddingVertical: 10, borderRadius: 8 },
  buttonDisabled: { backgroundColor: theme.colors.success },
  buttonText: { color: theme.colors.onPrimary, fontWeight: '600', fontSize: theme.type.body },
});